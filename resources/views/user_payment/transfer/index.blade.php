        ...
        <div class="panel-heading">
            ...
            <form action="/user-payment/transfer/payment/{{ $user_data->id }}" method="post" id="form"
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="email" email="" value="{{ $user_data->email }}" disabled>
                </div>
                <div class="form-group">
                ...
                <div style="margin-top: 10px" class="form-group">
                    ...
                    <div class="box">
                        <input type="file" id="file-1" class="inputfile inputfile-1"
                            data-multiple-caption="{count} files selected" multiple style="display: none" name="proof" />
